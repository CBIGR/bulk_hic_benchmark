...
chrom_size = pd.read_csv(f'/scratch/gent/vo/000/gvo00027/projects/CBIGR/24NHT_master_thesis/code/chromafold/ChromaFold/preprocessing_pipeline/assembly/{GENOME_ASSEMBLY}.chrom.sizes', #downloaded from UCSC
...
def main():
    ...
    chrom_size = pd.read_csv(f'/scratch/gent/vo/000/gvo00027/projects/CBIGR/24NHT_master_thesis/code/chromafold/ChromaFold/preprocessing_pipeline/assembly/{GENOME_ASSEMBLY}.chrom.sizes', 
                         sep = '\t', header = None, index_col = 0)
