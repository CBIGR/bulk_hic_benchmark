import packages.lightning.pytorch as pl
from packages.lightning.pytorch.loggers import WandbLogger
import argparse
import os
import torch
...
from packages.lightning.pytorch.callbacks import ModelSummary
import os
import shutil
import time
import argparse
...
def main(seq, chr, start, model_ckpt, model_ed_ckptt):
    ...
    if(seq is not None):
        ...
        start = int(start)        
        with open("/scratch/gent/vo/000/gvo00027/projects/CBIGR/24NHT_master_thesis/code/HiCDiffusion/hicdiffusion-dataset/data/GRCh38_full_analysis_set_plus_decoy_hla.fa") as handle:
